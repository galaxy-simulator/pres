...
\veryHuge \color{NavyBlue} \textbf{Generierung und Simulation von Galaxien} \color{Black}\\ % Title
\Huge\textit{Optimierung und Implementationsdetails}\\[2cm] % Subtitle
\huge \textbf{Emile Hansmaennel}\\[0.5cm] % Author(s)
\huge Theodor-Flieder-Gymnasium / Heinrich Heine Universität\\[0.4cm] % University/organization
\Large \texttt{emile.hansmaennel@gmail.com}\\
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
\includegraphics[width=20cm, trim={0 2em 0 2em}, clip]{figs/galaxy.png}\\
\end{minipage}
